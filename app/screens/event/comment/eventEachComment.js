...
export class EventEachComment extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchReplies() {
        ...
        const url = eventUrl + '/' + 'comments/' + comment.commentId + '/replies';
    ...
    doLike(cmtId) {
        ...
        const likeUrl = eventUrl + '/' + 'comments/' + cmtId + "/like";
    ...
    doUnlike(cmtId) {
        ...
        const unLikeUrl = eventUrl + '/' + 'comments/' + cmtId + '/unlike';
