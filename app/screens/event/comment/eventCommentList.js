...
import { EventEachComment } from './eventEachComment';
...
export class EventCommentList extends PureComponent {
    ...
    sendComment() {
        ...
        const { updateComment, eventId } = this.props;

        if (message != null) {
            let cmt = new FormData();
            cmt.append('eventId', eventId);
            ...
            fetch(eventUrl + '/' + 'comments', config)
                .then(res => res.json())
                    ...
                    commentsLoading ?
                        ...
                        comments.length === 0 ?
                            ...
                            <FlatList
                                ...
                                renderItem={(comment) => (<EventEachComment comment={comment.item} />)}
                            />
                }
