...
import { EventEachReply } from './eventEachReply';
import LoggedUserCredentials from '../../../utils/modal/LoggedUserCredentials';

export class EventReplyList extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            //reply message
    ...
    sendReply() {
        ...
        if (replyMessage != null) {
            ...
            const url = eventUrl + '/' + 'comments/' + commentId + '/replies';
                        ...
                        replies.length === 0 ?
                            ...
                            <ScrollView>
                                <FlatList
                                    ...
                                    renderItem={(reply) => (<EventEachReply reply={reply.item} />)}
                                />
                            </ScrollView>
                }
