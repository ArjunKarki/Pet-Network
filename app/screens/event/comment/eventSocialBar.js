...
export class EventSocialBar extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            likesCount: props.eventLikes.length,
            commentCount: props.eventCommentCount,
            eventId: props.eventId,
            isLiked: props.eventLikes.includes(LoggedUserCredentials.getOwnerId()),
            comments: [],
    ...
    onLike() {
        ...
        const likeUrl = eventUrl + '/' + eventId + "/like";
    ...
    onUnLike() {
        ...
        let unlikeUrl = eventUrl + '/' + eventId + "/unlike";
    ...
    getComments() {
        const { eventId } = this.state;
        const url = eventUrl + '/' + eventId + '/comments';
        const config = {
            headers: {
                'Authorization': 'Bearer ' + LoggedUserCredentials.getAccessToken()
            },
