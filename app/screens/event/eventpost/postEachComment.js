...
export class PostEachComment extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchReplies() {
        ...
        const url = eventUrl + '/eventposts/comments/' + comment.commentId + '/replies';
        const config = {
            headers: {
    ...
    doLike(cmtId) {
        ...
        const likeUrl = eventUrl + '/eventposts/comments/' + cmtId + "/like";
    ...
    doUnlike(cmtId) {
        ...
        const unLikeUrl = eventUrl + '/eventposts/comments/' + cmtId + '/unlike';
