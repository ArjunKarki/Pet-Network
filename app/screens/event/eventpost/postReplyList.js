...
import { PostEachReply } from './postEachReply';
import LoggedUserCredentials from '../../../utils/modal/LoggedUserCredentials';

export class PostReplyList extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            //reply message
    ...
    sendReply() {
        ...
        if (replyMessage != null) {
            ...
            const url = eventUrl + '/eventposts/comments/' + commentId + '/replies';
            fetch(url, config)
                        ...
                        replies.length === 0 ?
                            ...
                            <ScrollView>
                                <FlatList
                                    ...
                                    renderItem={(reply) => (<PostEachReply reply={reply.item} />)}
                                />
                            </ScrollView>
                }
