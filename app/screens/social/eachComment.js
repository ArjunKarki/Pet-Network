...
import { baseUrl, cmtUrl, ownerProPicUrl } from '../../utils/globle';
...
export class EachComment extends PureComponent {
    ...
    render() {
        ...
        const { comment } = this.props;
        let name = comment.commentor.firstName + " " + comment.commentor.lastName
        return (
            <View style={{ flex: 1 }}>
                <View style={cmtStyles.container}>
                    <TouchableOpacity >
                        <ImageLoad
                            ...
                            source={{ uri: ownerProPicUrl + "/" + comment.commentor._id }}
